...
<header
  class="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24 basis-[40%]"
>
  <div class="z-10">
    ...
    <h2
      class="mt-3 text-lg font-medium tracking-tight text-slate-100 sm:text-xl"
    >
      Full Stack Engineer
    </h2>
  ...
  <ul class="flex items-center z-10">
    <li class="mr-2">
      <a
        href="/"
        class="w-8 h-8 flex items-center justify-center rounded-md transition hover:bg-slate-900/5 dark:hover:bg-white/5"
      >
        <svg
    ...
    <li class="ml-auto mr-8">
      <button
        class="h-8 w-8 flex items-center justify-center rounded-md transition hover:bg-slate-900/5 dark:hover:bg-white/5"
      ...
      >
        <svg
          ...
          fill="none"
          viewBox="0 0 24 24"
          class="w-7 h-7 stroke-slate-400 stroke-[1.5] hidden dark:block"
        >
          <path
        ...
        <svg
          ...
          fill="none"
          viewBox="0 0 24 24"
          class="w-7 h-7 stroke-slate-400 stroke-[1.5] dark:hidden"
        >
          <path
            stroke-linecap="round"
            stroke-linejoin="round"
